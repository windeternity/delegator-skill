...
report_path: report-ReviewerB-routing-policy.md
...
---
# Task - ReviewerB routing policy review
...
Review whether the routing policy avoids treating worker count as proof of quality.
...
- Identify one strength or gap in the MOA quality boundary.
